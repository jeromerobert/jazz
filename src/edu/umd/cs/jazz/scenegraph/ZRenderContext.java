...
public class ZRenderContext extends Object {
     ...
     */
    protected boolean accurateSpacing = true;

    /**
     * greekText specifies that text should be rendered as "greek" rather than actual characters
     */
    protected boolean greekText = false;

    /** 
     * Constructs a new ZRenderContext.
     */
    public ZRenderContext(Graphics2D aG2, ZArea aVisibleArea, ZSurface aSurface, int qualityRequested) {
	surface = null;
	cameras = new Stack();
	...
	switch (quality) {
	case ZSurface.RENDER_QUALITY_LOW:
	    ...
	    setGreekText(true);
	    break;
	case ZSurface.RENDER_QUALITY_MEDIUM:
	    g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, 
					    RenderingHints.VALUE_ANTIALIAS_OFF);
	    g2.setRenderingHint(RenderingHints.KEY_TEXT_ANTIALIASING, 
					    RenderingHints.VALUE_TEXT_ANTIALIAS_OFF);
	    ...
	    setGreekText(false);
	    break;
	case ZSurface.RENDER_QUALITY_HIGH:
	    g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, 
