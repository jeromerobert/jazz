 ...
 * @author Lance Good
 */
public class ZScrollPaneLayout extends ScrollPaneLayout {
	...
	ZBounds cameraBounds = 
	    new ZBounds(0,0,extentSize.getWidth(),extentSize.getHeight());

	// LEG: Modification to ask the viewport for the view size rather
	// than asking the view directly
	Dimension viewPrefSize =  
	    (viewport != null) ? ((ZViewport)viewport).getViewSize(cameraBounds)
	    : new Dimension(0,0);
	...
	if ((vsb != null) && vsbNeeded) {
	    ...
	    viewPrefSize = ((ZViewport)viewport).getViewSize(cameraBounds);
	}
     ...
     */
    protected void adjustForVSB(boolean wantsVSB, Rectangle available,
     ...
     * private in ScrollPaneLayout so it was copied here
     */
    protected void adjustForHSB(boolean wantsHSB, Rectangle available,
    ...
    /**
     * The UI resource version of ZScrollPaneLayout.  It isn't clear why
     * Swing does this in ScrollPaneLayout but we'll do it here too just
     * to be safe.
     */
    public static class UIResource extends ZScrollPaneLayout implements javax.swing.plaf.UIResource {}
}
