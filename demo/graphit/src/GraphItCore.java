...
/**
 * <b>GraphItCore</b> implements the core of GraphIt that
...
public class GraphItCore {
        ...
        ZCompositeSelectionHandler selectionHandler = null;
...
/**
 * GraphItCore constructor comment.
 */
public GraphItCore(ZCanvas aCanvas) {
        super();
        ...
        ZNode node;
        ZNode handle;
        ArrayList selection = ZSelectionManager.getSelectedNodes(canvas.getCamera());
        ...
        selectionHandler = new ZCompositeSelectionHandler(canvas.getCameraNode(),canvas,selectionLayer);
        ...
        case PAN_MODE:
            ...
            break;
        case SELECT_MODE:
            currentEventHandler = selectionHandler;
            canvas.setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
            break;
        case DRAW_MODE:
        ...
        for (Iterator i=selection.iterator(); i.hasNext();) {
            ...
            if (node.getClientProperty("group") != null) {
                ...
                ZSelectionManager.unselect(group);
                ...
                for (int j=0; j<children.length; j++) {
                    ...
                    ZSelectionManager.select(children[j].editor().getNode());
                }
