...
all :
	cd src; javac -d classes edu/umd/cs/jazz/*.java edu/umd/cs/jazz/component/*.java edu/umd/cs/jazz/event/*.java edu/umd/cs/jazz/io/*.java edu/umd/cs/jazz/util/*.java 
