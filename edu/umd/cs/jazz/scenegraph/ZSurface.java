...
public class ZSurface implements Printable {
     ...
     * @param qualityRequested Can be <code>RENDER_QUALITY_LOW</code> or
     * <code>RENDER_QUALITY_HIGH</code>.
     */
	...
	setRenderingHints(g2, renderQuality);
	ZRenderContext rc = new ZRenderContext(g2, paintArea, this);
	camera.paint(rc);
	...
	setRenderingHints(g2, RENDER_QUALITY_HIGH);
	ZRenderContext rc = new ZRenderContext(g2, new ZArea(camera.getViewBounds()), this);
	camera.paint(rc);
