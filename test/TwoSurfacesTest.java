 ...
 */
public class TwoSurfacesTest extends JFrame {
	...
	ZEventHandler selectionEventHandler = new ZSelectionEventHandler(canvas1.getCameraNode(), canvas1, selectionLayer);
	...
	TwoSurfacesTest app = new TwoSurfacesTest();
    }
}
