...
public class SwingJazzTest {
	...
	try {
	    ...
	    final JEditorPane editorPane = new JEditorPane("file:"+
	...
	Action letter = new AbstractAction("Big A!",new ImageIcon(".."+
							      System.getProperty("file.separator")+
							      "demo"+
							      System.getProperty("file.separator")+
							      "hinote"+
	...
	Action hand = new AbstractAction("Hi!",new ImageIcon(".."+
							      System.getProperty("file.separator")+
							      "demo"+
							      System.getProperty("file.separator")+
							      "hinote"+
